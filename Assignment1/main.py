...
def problem1():
    ...
    img = load_image("C:/Users/dreams/anaconda3/uebung/assignment1/data/a1p1.png")
    display_image(img)
...
def problem2():
    ...
    data = loaddata("C:/Users/dreams/anaconda3/uebung/assignment1/data/bayerdata.npy")
...
def problem3():
    ...
    print(P)  #P-3x4  Calibration
    print(M)   #M-4x4 Extrinsic (world2Camera)
    ...
    Xt = invertprojection(K, points, z)  #Xt--P3d 3x2904 Marix in cart
    Xh = inverttransformation(M, Xt)     #Xh--4x2904 in homo
   
    worldpoints = hom2cart(Xh) # 3x2904 Marix in cart
    ...
    commut=p3multiplecoice()
    print(commut,":The transformations do not commute.")
...
def problem4():
    ...
    detectedges(imgx,imgy,threshold)
